...
void DefFileReader::AddFuncNames(MetaData* pMD, MSTRING sKey, MSTRING sVal) {
    ...
    ADD_FUNC_NAME(ADD_NODE_TO_LIST)
	ADD_FUNC_NAME(SEEK)
    ...
    ADD_FUNC_NAME(MASK_VALUE)

    ADD_FUNC_NAME(MASK_FIRST_NAME)
    ADD_FUNC_NAME(MASK_LAST_NAME)
    ADD_FUNC_NAME(MASK_FULL_NAME)
    ADD_FUNC_NAME(MASK_DATE)
    ADD_FUNC_NAME(MASK_MONTH)
    ADD_FUNC_NAME(MASK_YEAR)
    ADD_FUNC_NAME(MASK_HOUR)
    ADD_FUNC_NAME(MASK_MINUTE)
    ADD_FUNC_NAME(MASK_SECONDS)
    ADD_FUNC_NAME(MASK_TELEPHONE_NUMBER)
    ADD_FUNC_NAME(MASK_ADDRESS)
    ADD_FUNC_NAME(MASK_POSTAL_CODE)
    ADD_FUNC_NAME(MASK_INTEGER)
    ADD_FUNC_NAME(MASK_PRICE)
    ADD_FUNC_NAME(MASK_NIC)
}
